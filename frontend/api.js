...
(function () {
  ...
  const Api = {
    ...
    catalog: {
      /**
       * Справочник предметов: id, название, цвет кружка и короткий код
       * для режима дальтоников. Берите его отсюда, а не из константы в
       * app.js — иначе цвета и идентификаторы разойдутся с базой.
       */
      subjects() {
